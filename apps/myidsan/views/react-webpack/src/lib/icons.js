...
// Shared SVG icon set, ported verbatim from myseliasan so the RBAC apps share one
// icon vocabulary (Feather-style line glyphs drawn with currentColor).
export const icoSvg = {
...
export function Ico({ n, sz = 16, style: extraStyle }) {
  return (
    <svg
      width={sz}
      height={sz}
