# Module: domain/shared/apis/user_group.go
...
- GET returns shared output DTOs through `IUserGroupDtoService`.
- POST/PUT decode shared input DTOs, then project them to `UserGroup` entities for service writes.
