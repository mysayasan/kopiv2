...
- Projects paginated RBAC rows, current-user endpoint joins, and validation results into selected DTO types.
- Supports separate DTO types for base RBAC rows and joined endpoint views.
