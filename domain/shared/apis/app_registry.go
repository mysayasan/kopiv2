...
func (m *appRegistryApi) get(w http.ResponseWriter, r *http.Request) {
	opts, err := parseListQueryOptions[entities.AppRegistry](r)
	if err != nil {
...
func (m *appRegistryApi) post(w http.ResponseWriter, r *http.Request) {
	body, err := decodeRequestDto[inputdtos.AppRegistryDto, entities.AppRegistry](w, r)
	if err != nil {
...
func (m *appRegistryApi) put(w http.ResponseWriter, r *http.Request) {
	body, err := decodeRequestDto[inputdtos.AppRegistryDto, entities.AppRegistry](w, r)
	if err != nil {
		controllers.SendError(w, controllers.ErrParseFailed, err.Error())
		return
...
func (m *appRegistryApi) delete(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
