...
// The default is to KEEP it: the database holds every suite user, role and registered SSO
// client, so destroying it means re-registering every relying app. A tester wanting a
// clean first-run experience just answers Yes.
...
begin
  ...
  begin
    ...
    if UninstallSilent then
      Exit;
    if MsgBox('Also delete all MyIDSan data — the database of users, roles and registered' + #13#10 +
